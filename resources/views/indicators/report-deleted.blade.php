            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Restore Indicator Report ')}}</h5>
                        ...
                        <table id="data_table" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="/report/trashed/{{$report->slug}}"><i class="ik ik-check-square f-16 mr-15 text-green"></i></a>
                                    <a href="/report/permanent/{{$report->slug}}"><i class="ik ik-trash-2 f-16 text-red"></i></a>
                                    </td>
                                </tr>                    
                                @empty
                                There are no indicator reports  available at this moment 
                                @endforelse
                            </tbody>
                        </table>
                    </div>
