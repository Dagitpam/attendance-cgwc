            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('Add New Data')}}</h3>
                    </div>
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="/tracker/store" >
                        @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="female" type="number" class="form-control @error('female') is-invalid @enderror" name="female" value="" placeholder="Enter number of females">
                                        <div class="help-block with-errors"></div>
                                        @error('female')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="male" type="number" class="form-control @error('male') is-invalid @enderror" name="male" value="" placeholder="Enter number of males">
                                        <div class="help-block with-errors"></div>
                                        @error('female')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="other" type="number" class="form-control @error('other') is-invalid @enderror" name="other" value="" placeholder="Enter Other indicators">
                                        <div class="help-block with-errors"></div>
                                        @error('other')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
