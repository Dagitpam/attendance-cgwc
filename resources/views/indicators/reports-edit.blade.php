            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('Update Report')}}</h3>
                    </div>
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="/report/update" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="activity" type="text" class="form-control @error('female') is-invalid @enderror" name="activity" value="{{$report->activity}}" placeholder="Enter Activity">
                                        <div class="help-block with-errors"></div>
                                        @error('activity')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="target" type="text" class="form-control @error('target') is-invalid @enderror" name="target" value="{{$report->target}}" placeholder="Enter Target">
                                        <div class="help-block with-errors"></div>
                                        @error('target')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="results" type="text" class="form-control @error('target') is-invalid @enderror" name="results" value="{{$report->results}}" placeholder="Enter Results">
                                        <div class="help-block with-errors"></div>
                                        @error('target')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="reported_by" type="text" class="form-control @error('reported_by') is-invalid @enderror" name="reported_by" value="{{$report->reported_by}}" placeholder="Reported By">
                                        <div class="help-block with-errors"></div>
                                        @error('reported_by')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
